...
class Filter {
  ...
  setClusterDropdown(id, exp) {
    ...
    $.get(url).then(response => {
      ...
      console.log(`#${id}FilterList`, response)
      $(`#${id}FilterList`).empty();
